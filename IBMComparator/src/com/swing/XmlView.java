...
public class XmlView extends PlainView {
    ...
    private static String XSI_ATTRIBUTE_PATTERN = "\\s(xsi:type*)\\=";
    private static String XMNLS_ATTRIBUTE_PATTERN = "\\s(xmlns:.*)\\=";
    ...
    static {
        ...
        patternColors
                .put(Pattern.compile(TAG_PATTERN), new Color(42,
                        0, 255));
       
        patternColors.put(Pattern.compile(TAG_ATTRIBUTE_PATTERN), Color.red);
        patternColors.put(Pattern.compile(XMNLS_ATTRIBUTE_PATTERN), Color.red);
        patternColors.put(Pattern.compile(XSI_ATTRIBUTE_PATTERN), Color.red);
        patternColors.put(Pattern.compile(TAG_END_PATTERN), new Color(42,
                0, 255));
